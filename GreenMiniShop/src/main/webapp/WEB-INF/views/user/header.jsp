...
<body>
	...
	<div class="main-top">
     ...
     <a href="${pageContext.request.contextPath}/logout">Logout</a>
							...
							<c:if test="${pageContext.request.userPrincipal.name != null">logout</c:if> --%>
					...
					<div style="max-height: 50px;">
								...
								<div class="row infor">
									...
									<c:choose>
										<c:when test="${pageContext.request.userPrincipal.name != null}">
											<div class="sig">
										<div>
											<a href="#" class="">${pageContext.request.userPrincipal.name}</a>
										</div>
										<a href="${pageContext.request.contextPath}/logout" class="">Đăng xuất</a>
									</div>
										</c:when>
										<c:otherwise>
											<div class="sig">
						...
						<div class="row" style="max-height: 40px; margin-top: 0px;">
							<nav class="navbar navbar-expand-lg navbar-default bootsnav"
								...
								<div class="container" style="margin-top: 20px; padding-top: -5px">
									...
									<div class="collapse navbar-collapse" id="navbar-menu">
										<ul class="nav navbar-nav menu_list" data-in="fadeInDown"
											...
											<li class="dropdown active"><a href="#"
												class="nav-link dropdown-toggle arrow"
												data-toggle="dropdown">Cửa hàng &#8744</a>
